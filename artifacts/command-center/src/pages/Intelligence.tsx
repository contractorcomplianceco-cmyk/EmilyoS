      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-primary/5 to-accent/5 p-6 sm:p-8 border border-white shadow-sm text-slate-700">
        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-800">Intelligence & Insights</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="overflow-hidden border-slate-100 bg-white/80 shadow-sm backdrop-blur-md">
          ...
          <div className="p-5 space-y-4">
            <div className="p-4 bg-primary/5 rounded-xl border border-primary/20 hover:border-primary/30 transition-colors">
              <p className="text-sm font-bold text-slate-800 mb-1.5 flex items-center gap-2">
                <TrendingUp className="w-4 h-4 text-primary" /> Texas Comptroller
              </p>
            ...
            <div className="p-4 bg-primary/5 rounded-xl border border-primary/20 hover:border-primary/30 transition-colors">
              <p className="text-sm font-bold text-slate-800 mb-1.5 flex items-center gap-2">
                <TrendingUp className="w-4 h-4 text-primary" /> California CSLB
              </p>
        ...
        <Card className="md:col-span-2 overflow-hidden border-slate-100 bg-white/80 shadow-sm backdrop-blur-md">
          <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-5 py-4">
            <h3 className="flex items-center gap-2.5 text-lg font-bold text-slate-800">
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="flex items-center gap-4">
              <div className="w-full bg-slate-100 rounded-full h-2">
                <div className="bg-accent/100 h-2 rounded-full" style={{ width: healthPct(db.agencies.length) }}></div>
              </div>
              <span className="text-sm font-semibold whitespace-nowrap">{db.agencies.length} Agencies</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-full bg-slate-100 rounded-full h-2">
                <div className="bg-primary/100 h-2 rounded-full" style={{ width: healthPct(db.matters.length) }}></div>
              </div>
