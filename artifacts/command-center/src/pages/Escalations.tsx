...
export default function Escalations() {
  ...
  const kpis = [
    { label: "Total Escalations", value: stats.total, icon: Scale, gradient: "from-primary to-sky-400", shadow: "hover:shadow-primary/20" },
    { label: "Active & Open", value: stats.open, icon: Siren, gradient: "from-primary to-accent", shadow: "hover:shadow-primary/20" },
    { label: "Awaiting Decision", value: stats.awaitingDecision, icon: ShieldAlert, gradient: "from-accent to-pink-300", shadow: "hover:shadow-accent/20" },
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-primary/5 to-accent/5 p-6 sm:p-8 border border-white shadow-sm">
        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-800">Escalation Queue</h2>
